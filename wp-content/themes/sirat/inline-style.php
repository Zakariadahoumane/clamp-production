<?php
	...
	$sirat_navigation_menu_font_weight = get_theme_mod('sirat_navigation_menu_font_weight','600');
	if($sirat_navigation_menu_font_weight != false){
		$sirat_custom_css .='.main-menu-navigation a{';
			$sirat_custom_css .='font-weight: '.esc_attr($sirat_navigation_menu_font_weight).';';
		$sirat_custom_css .='}';
	}

	$sirat_theme_lay = get_theme_mod( 'sirat_menu_text_transform','Uppercase');
	...
	$sirat_resp_slider = get_theme_mod( 'sirat_resp_slider_hide_show',true);
	...
	$sirat_resp_slider_button = get_theme_mod( 'sirat_resp_slider_btn_hide_show',true);
	...
	$sirat_copyright_background_color = get_theme_mod('sirat_copyright_background_color');
	if($sirat_copyright_background_color != false){
		$sirat_custom_css .='#footer-2{';
			$sirat_custom_css .='background-color: '.esc_attr($sirat_copyright_background_color).';';
		$sirat_custom_css .='}';
	}
	...
	$sirat_theme_lay = get_theme_mod( 'sirat_img_footer','scroll');
	if($sirat_theme_lay == 'fixed'){
		$sirat_custom_css .='#footer{';
			$sirat_custom_css .='background-attachment: fixed !important;';
		$sirat_custom_css .='}';
	}elseif ($sirat_theme_lay == 'scroll'){
		$sirat_custom_css .='#footer{';
			$sirat_custom_css .='background-attachment: scroll !important;';
		$sirat_custom_css .='}';
	}

	$sirat_footer_img_position = get_theme_mod('sirat_footer_img_position','center center');
	if($sirat_footer_img_position != false){
		$sirat_custom_css .='#footer{';
			$sirat_custom_css .='background-position: '.esc_attr($sirat_footer_img_position).'!important;';
		$sirat_custom_css .='}';
	} 
	...
	if($sirat_footer_background_image != false){
		$sirat_custom_css .='#footer{';
			$sirat_custom_css .='background: url('.esc_attr($sirat_footer_background_image).'); background-size: cover;';
		$sirat_custom_css .='}';
	}
	...
	$sirat_menus_item = get_theme_mod( 'sirat_menus_item_style','None');
    if($sirat_menus_item == 'None'){
		$sirat_custom_css .='.main-menu-navigation a{';
			$sirat_custom_css .='';
		$sirat_custom_css .='}';
	}else if($sirat_menus_item == 'Zoom In'){
		$sirat_custom_css .='.main-menu-navigation a:hover{';
			$sirat_custom_css .='transition: all 0.3s ease-in-out !important; transform: scale(1.2) !important; color: #ffcc05;';
		$sirat_custom_css .='}';
	}
	...
	$sirat_preloader_bg_img = get_theme_mod('sirat_preloader_bg_img');
	if($sirat_preloader_bg_img != false){
		$sirat_custom_css .='#preloader{';
			$sirat_custom_css .='background: url('.esc_attr($sirat_preloader_bg_img).');-webkit-background-size: cover; -moz-background-size: cover; -o-background-size: cover; background-size: cover;';
		$sirat_custom_css .='}';
	}

	// Header Background Color
	$sirat_header_background_color = get_theme_mod('sirat_header_background_color');
	if($sirat_header_background_color != false){
		$sirat_custom_css .='.home-page-header{';
			$sirat_custom_css .='background-color: '.esc_attr($sirat_header_background_color).';';
		$sirat_custom_css .='}';
	}

	$sirat_header_img_position = get_theme_mod('sirat_header_img_position','center top');
	if($sirat_header_img_position != false){
		$sirat_custom_css .='.home-page-header{';
			$sirat_custom_css .='background-position: '.esc_attr($sirat_header_img_position).'!important;';
		$sirat_custom_css .='}';
	}
	...
	$sirat_display_grid_posts_settings = get_theme_mod( 'sirat_display_grid_posts_settings','Into Blocks');
    if($sirat_display_grid_posts_settings == 'Without Blocks'){
		$sirat_custom_css .='.grid-post-main-box{';
			$sirat_custom_css .='box-shadow: none; border: none; margin:30px 0;';
		$sirat_custom_css .='}';
	}
	...
	$sirat_custom_css .='#footer h3, #footer .wp-block-search .wp-block-search__label, a.rsswidget.rss-widget-title{';
		$sirat_custom_css .='letter-spacing: '.esc_attr($sirat_button_footer_heading_letter_spacing).'px;';
	$sirat_custom_css .='}';

	$sirat_button_footer_font_size = get_theme_mod('sirat_button_footer_font_size','25');
	$sirat_custom_css .='#footer h3, #footer .wp-block-search .wp-block-search__label, a.rsswidget.rss-widget-title{';
		$sirat_custom_css .='font-size: '.esc_attr($sirat_button_footer_font_size).'px;';
	$sirat_custom_css .='}';

	$sirat_theme_lay = get_theme_mod( 'sirat_button_footer_text_transform','Capitalize');
	if($sirat_theme_lay == 'Capitalize'){
		$sirat_custom_css .='#footer h3, #footer .wp-block-search .wp-block-search__label{';
			$sirat_custom_css .='text-transform:Capitalize;';
		$sirat_custom_css .='}';
	...
	$sirat_footer_heading_weight = get_theme_mod('sirat_footer_heading_weight');
	if($sirat_footer_heading_weight != false){
		$sirat_custom_css .='#footer h3, #footer .wp-block-search .wp-block-search__label, a.rsswidget.rss-widget-title{';
			$sirat_custom_css .='font-weight: '.esc_attr($sirat_footer_heading_weight).';';
		$sirat_custom_css .='}';
	}

	/*---------------------------Footer Style -------------------*/

	$sirat_theme_lay = get_theme_mod( 'sirat_footer_template','sirat-footer-one');
    if($sirat_theme_lay == 'sirat-footer-one'){
		$sirat_custom_css .='#footer{';
			$sirat_custom_css .='';
		$sirat_custom_css .='}';

	}else if($sirat_theme_lay == 'sirat-footer-two'){
		$sirat_custom_css .='#footer{';
			$sirat_custom_css .='background: linear-gradient(to right, #f9f8ff, #dedafa);';
		$sirat_custom_css .='}';
		$sirat_custom_css .='#footer p, #footer li a, #footer, #footer h3, #footer a.rsswidget, #footer #wp-calendar a, .copyright a, #footer .custom_details, #footer ins span, #footer .tagcloud a, .main-inner-box span.entry-date a, nav.woocommerce-MyAccount-navigation ul li:hover a, #footer ul li a, #footer table, #footer th, #footer td, #footer caption, #sidebar caption,#footer nav.wp-calendar-nav a,#footer .search-form .search-field{';
			$sirat_custom_css .='color:#000;';
		$sirat_custom_css .='}';
		$sirat_custom_css .='#footer ul li::before{';
			$sirat_custom_css .='background:#000;';
		$sirat_custom_css .='}';
		$sirat_custom_css .='#footer table, #footer th, #footer td,#footer .search-form .search-field,#footer .tagcloud a{';
			$sirat_custom_css .='border: 1px solid #000;';
		$sirat_custom_css .='}';

	}else if($sirat_theme_lay == 'sirat-footer-three'){
		$sirat_custom_css .='#footer{';
			$sirat_custom_css .='background: #232524;';
		$sirat_custom_css .='}';
	}
	else if($sirat_theme_lay == 'sirat-footer-four'){
		$sirat_custom_css .='#footer{';
			$sirat_custom_css .='background: #f7f7f7;';
		$sirat_custom_css .='}';
		$sirat_custom_css .='#footer p, #footer li a, #footer, #footer h3, #footer a.rsswidget, #footer #wp-calendar a, .copyright a, #footer .custom_details, #footer ins span, #footer .tagcloud a, .main-inner-box span.entry-date a, nav.woocommerce-MyAccount-navigation ul li:hover a, #footer ul li a, #footer table, #footer th, #footer td, #footer caption, #sidebar caption,#footer nav.wp-calendar-nav a,#footer .search-form .search-field{';
			$sirat_custom_css .='color:#000;';
		$sirat_custom_css .='}';
	...
	else if($sirat_theme_lay == 'sirat-footer-five'){
		$sirat_custom_css .='#footer{';
			$sirat_custom_css .='background: linear-gradient(to right, #01093a, #2d0b00);';
		$sirat_custom_css .='}';
	}

	$sirat_responsive_preloader_hide = get_theme_mod('sirat_responsive_preloader_hide',false);
	if($sirat_responsive_preloader_hide == true && get_theme_mod('sirat_loader_enable',false) == false){
		$sirat_custom_css .='@media screen and (min-width:575px){
			#preloader{';
			$sirat_custom_css .='display:none !important;';
		$sirat_custom_css .='} }';
	}

	if($sirat_responsive_preloader_hide == false){
		$sirat_custom_css .='@media screen and (max-width:575px){
			#preloader{';
			$sirat_custom_css .='display:none !important;';
		$sirat_custom_css .='} }';
