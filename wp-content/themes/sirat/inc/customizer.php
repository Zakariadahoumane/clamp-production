...
function sirat_customize_register( $wp_customize ) {
	...
	$wp_customize->add_setting('sirat_header_background_color', array(
		'default'           => '',
		'sanitize_callback' => 'sanitize_hex_color',
	));
	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'sirat_header_background_color', array(
		'label'    => __('Header Background Color', 'sirat'),
		'section'  => 'header_image',
	)));

	$wp_customize->add_setting('sirat_header_img_position',array(
	  'default' => 'center top',
	  'transport' => 'refresh',
	  'sanitize_callback' => 'sirat_sanitize_choices'
	));
	$wp_customize->add_control('sirat_header_img_position',array(
		'type' => 'select',
		'label' => __('Header Image Position','sirat'),
		'section' => 'header_image',
		'choices' 	=> array(
			'left top' 		=> esc_html__( 'Top Left', 'sirat' ),
			'center top'   => esc_html__( 'Top', 'sirat' ),
			'right top'   => esc_html__( 'Top Right', 'sirat' ),
			'left center'   => esc_html__( 'Left', 'sirat' ),
			'center center'   => esc_html__( 'Center', 'sirat' ),
			'right center'   => esc_html__( 'Right', 'sirat' ),
			'left bottom'   => esc_html__( 'Bottom Left', 'sirat' ),
			'center bottom'   => esc_html__( 'Bottom', 'sirat' ),
			'right bottom'   => esc_html__( 'Bottom Right', 'sirat' ),
		),
	));
	...
	//Menus Settings
	$wp_customize->add_section( 'sirat_menus_setting', array(
    	'title'      => __( 'Menus Settings', 'sirat' ),
		'panel' => 'sirat_homepage_panel'
	) );
	...
	// text trasform
	$wp_customize->add_setting('sirat_menu_text_transform',array(
		'default'=> 'Uppercase',
		'sanitize_callback'	=> 'sirat_sanitize_choices'
	));
	$wp_customize->add_control('sirat_menu_text_transform',array(
		'type' => 'radio',
		'label'	=> __('Menus Text Transform','sirat'),
		'choices' => array(
            'Uppercase' => __('Uppercase','sirat'),
            'Capitalize' => __('Capitalize','sirat'),
            'Lowercase' => __('Lowercase','sirat'),
        ),
		'section'=> 'sirat_menus_setting',
	));
	...
	$wp_customize->add_setting('sirat_menus_item_style',array(
        'default' => '',
        'transport' => 'refresh',
        'sanitize_callback' => 'sirat_sanitize_choices'
	));
	$wp_customize->add_control('sirat_menus_item_style',array(
        'type' => 'select',
        'section' => 'sirat_menus_setting',
		'label' => __('Menu Item Hover Style','sirat'),
		'choices' => array(
            'None' => __('None','sirat'),
	...
	$wp_customize->add_section(
		'sirat_social_links', array(
			'title'		=>	__('Social Links', 'sirat'),
			'priority'	=>	null,
			'panel'		=>	'sirat_homepage_panel'
		)
	);

	$wp_customize->add_setting('sirat_social_icons',array(
		'default'=> '',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('sirat_social_icons',array(
		'label' =>  __('Steps to setup social icons','sirat'),
		'description' => __('<p>1. Go to Dashboard >> Appearance >> Widgets</p>
			<p>2. Add Vw Social Icon Widget in Top Bar Social Media area.</p>
			<p>3. Add social icons url and save.</p>','sirat'),
		'section'=> 'sirat_social_links',
		'type'=> 'hidden'
	));
	$wp_customize->add_setting('sirat_social_icon_btn',array(
		'default'=> '',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('sirat_social_icon_btn',array(
    ...
    $wp_customize->add_setting('sirat_slider_type',array(
        'default' => 'Default slider',
        'sanitize_callback' => 'sirat_sanitize_choices'
	) );
	$wp_customize->add_control('sirat_slider_type', array(
        'type' => 'select',
        'label' => __('Slider Type','sirat'),
        'section' => 'sirat_slidersettings',
        'choices' => array(
            'Default slider' => __('Default slider','sirat'),
            'Advance slider' => __('Advance slider','sirat'),
        ),
	));

	$wp_customize->add_setting('sirat_advance_slider_shortcode',array(
		'default'=> '',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('sirat_advance_slider_shortcode',array(
		'label'	=> __('Add Slider Shortcode','sirat'),
		'section'=> 'sirat_slidersettings',
		'type'=> 'text',
		'active_callback' => 'sirat_advance_slider'
	));
    ...
    $wp_customize->add_control( new Sirat_Toggle_Switch_Custom_Control( $wp_customize, 'sirat_slider_indicator_show_hide',array(
		...
		'section' => 'sirat_slidersettings',
		'active_callback' => 'sirat_default_slider'
    )));

	$wp_customize->add_setting('sirat_events_small_heading',array(
		'default'=> '',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('sirat_events_small_heading',array(
		'label'	=> __('Add Slider Small Text','sirat'),
		'section'=> 'sirat_slidersettings',
		'type'=> 'text',
		'active_callback' => 'sirat_default_slider'
	));
	...
	$wp_customize->add_setting('sirat_top_button_url',array(
		'default'	=> '',
		'sanitize_callback'	=> 'esc_url_raw'
	));
	$wp_customize->add_control('sirat_top_button_url',array(
		'label'	=> __('Add Button URL','sirat'),
		'section'	=> 'sirat_slidersettings',
		'setting'	=> 'sirat_top_button_url',
		'type'	=> 'url',
		'active_callback' => 'sirat_default_slider'
	));
    ...
    $wp_customize->add_control( new Sirat_Toggle_Switch_Custom_Control( $wp_customize, 'sirat_slider_image_overlay',array(
      	'label' => esc_html__( 'Show / Hide Slider Image Overlay','sirat' ),
      	'section' => 'sirat_slidersettings',
      	'active_callback' => 'sirat_default_slider'
    )));
	...
	$wp_customize->add_setting( 'sirat_footer_hide_show',array(
      'default' => 1,
      'transport' => 'refresh',
      'sanitize_callback' => 'sirat_switch_sanitization'
    ));
    $wp_customize->add_control( new Sirat_Toggle_Switch_Custom_Control( $wp_customize, 'sirat_footer_hide_show',array(
      'label' => esc_html__( 'Show / Hide Footer','sirat' ),
      'section' => 'sirat_footer'
    )));

 	// font size
	$wp_customize->add_setting('sirat_button_footer_font_size',array(
		'default'=> 25,
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('sirat_button_footer_font_size',array(
		'label'	=> __('Footer Heading Font Size','sirat'),
  		'type'        => 'number',
		'input_attrs' => array(
			'step'             => 1,
			'min'              => 1,
	...
	$wp_customize->add_setting('sirat_button_footer_heading_letter_spacing',array(
		'default'=> 1,
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('sirat_button_footer_heading_letter_spacing',array(
		'label'	=> __('Heading Letter Spacing','sirat'),
  		'type'        => 'number',
		'input_attrs' => array(
			'step'             => 1,
			'min'              => 1,
	...
	// text trasform
	$wp_customize->add_setting('sirat_button_footer_text_transform',array(
		'default'=> 'Capitalize',
		'sanitize_callback'	=> 'sirat_sanitize_choices'
	));
	$wp_customize->add_control('sirat_button_footer_text_transform',array(
		'type' => 'radio',
		'label'	=> __('Heading Text Transform','sirat'),
		'choices' => array(
      'Uppercase' => __('Uppercase','sirat'),
      'Capitalize' => __('Capitalize','sirat'),
      'Lowercase' => __('Lowercase','sirat'),
	...
	$wp_customize->add_setting('sirat_footer_heading_weight',array(
        'default' => '',
        'transport' => 'refresh',
        'sanitize_callback' => 'sirat_sanitize_choices'
	));
	$wp_customize->add_control('sirat_footer_heading_weight',array(
        'type' => 'select',
        'label' => __('Heading Font Weight','sirat'),
        'section' => 'sirat_footer',
        'choices' => array(
        	'100' => __('100','sirat'),
            '200' => __('200','sirat'),
  	...
  	$wp_customize->add_setting('sirat_footer_template',array(
	    'default'	=> esc_html('sirat-footer-one'),
	    'sanitize_callback'	=> 'sirat_sanitize_choices'
  	));
 	$wp_customize->add_control('sirat_footer_template',array(
        'label'	=> esc_html__('Footer style','sirat'),
        'section'	=> 'sirat_footer',
        'setting'	=> 'sirat_footer_template',
        'type' => 'select',
        'choices' => array(
            'sirat-footer-one' => esc_html__('Style 1', 'sirat'),
            'sirat-footer-two' => esc_html__('Style 2', 'sirat'),
            'sirat-footer-three' => esc_html__('Style 3', 'sirat'),
            'sirat-footer-four' => esc_html__('Style 4', 'sirat'),
            'sirat-footer-five' => esc_html__('Style 5', 'sirat'),
        )
  	));
	...
	// footer padding
	$wp_customize->add_setting('sirat_footer_padding',array(
		'default'=> '',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('sirat_footer_padding',array(
		'label'	=> __('Footer Top Bottom Padding','sirat'),
		'description'	=> __('Enter a value in pixels. Example:20px','sirat'),
		'input_attrs' => array(
      'placeholder' => __( '10px', 'sirat' ),
    ),
	...
	$wp_customize->add_setting('sirat_footer_img_position',array(
	  'default' => 'center center',
	  'transport' => 'refresh',
	  'sanitize_callback' => 'sirat_sanitize_choices'
	));
	$wp_customize->add_control('sirat_footer_img_position',array(
		'type' => 'select',
		'label' => __('Footer Image Position','sirat'),
		'section' => 'sirat_footer',
		'choices' 	=> array(
			'left top' 		=> esc_html__( 'Top Left', 'sirat' ),
			'center top'   => esc_html__( 'Top', 'sirat' ),
	...
	// Footer
	$wp_customize->add_setting('sirat_img_footer',array(
		'default'=> 'scroll',
		'sanitize_callback'	=> 'sirat_sanitize_choices'
	));
	$wp_customize->add_control('sirat_img_footer',array(
		'type' => 'select',
		'label'	=> __('Footer Background Attatchment','sirat'),
		'choices' => array(
            'fixed' => __('fixed','sirat'),
            'scroll' => __('scroll','sirat'),
        ),
		'section'=> 'sirat_footer',
	));
	...
	$wp_customize->add_setting('sirat_footer_widgets_content',array(
        'default' => 'Left',
        'transport' => 'refresh',
        'sanitize_callback' => 'sirat_sanitize_choices'
	));
	$wp_customize->add_control('sirat_footer_widgets_content',array(
        'type' => 'select',
        'label' => __('Footer Widget Content','sirat'),
        'section' => 'sirat_footer',
        'choices' => array(
        	'Left' => __('Left','sirat'),
            'Center' => __('Center','sirat'),
    ...
    // footer social icon
  	$wp_customize->add_setting( 'sirat_footer_icon',array(
		'default' => false,
		'transport' => 'refresh',
		'sanitize_callback' => 'sirat_switch_sanitization'
    ) );
  	$wp_customize->add_control( new Sirat_Toggle_Switch_Custom_Control( $wp_customize, 'sirat_footer_icon',array(
		'label' => esc_html__( 'Show / Hide Footer Social Icon','sirat' ),
		'section' => 'sirat_footer'
    )));
	...
	$wp_customize->add_setting( 'sirat_copyright_hide_show',array(
      'default' => 1,
      'transport' => 'refresh',
      'sanitize_callback' => 'sirat_switch_sanitization'
    ));
    $wp_customize->add_control( new Sirat_Toggle_Switch_Custom_Control( $wp_customize, 'sirat_copyright_hide_show',array(
      'label' => esc_html__( 'Show / Hide Copyright','sirat' ),
      'section' => 'sirat_footer'
    )));

	$wp_customize->add_setting('sirat_copyright_background_color', array(
		'default'           => '#febe00',
		'sanitize_callback' => 'sanitize_hex_color',
	));
	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'sirat_copyright_background_color', array(
		'label'    => __('Copyright Background Color', 'sirat'),
		'section'  => 'sirat_footer',
	)));
	...
	$wp_customize->add_control('sirat_blog_page_posts_settings',array(
        'type' => 'select',
        'label' => __('Display Blog Posts','sirat'),
        'section' => 'sirat_post_settings',
        'choices' => array(
	...
	// font size button
	$wp_customize->add_setting('sirat_button_font_size',array(
		'default'=> '',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('sirat_button_font_size',array(
		'label'	=> __('Button Font Size','sirat'),
		'description'	=> __('Enter a value in pixels. Example:20px','sirat'),
		'input_attrs' => array(
      	'placeholder' => __( '10px', 'sirat' ),
    ),
	...
	$wp_customize->add_setting('sirat_button_letter_spacing',array(
		'default'=> '',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('sirat_button_letter_spacing',array(
		'label'	=> __('Button Letter Spacing','sirat'),
		'description'	=> __('Enter a value in pixels. Example:20px','sirat'),
		'input_attrs' => array(
      	'placeholder' => __( '10px', 'sirat' ),
    ),
	...
	// text trasform
	$wp_customize->add_setting('sirat_button_text_transform',array(
		'default'=> 'Uppercase',
		'sanitize_callback'	=> 'sirat_sanitize_choices'
	));
	$wp_customize->add_control('sirat_button_text_transform',array(
		'type' => 'radio',
		'label'	=> __('Button Text Transform','sirat'),
		'choices' => array(
            'Uppercase' => __('Uppercase','sirat'),
            'Capitalize' => __('Capitalize','sirat'),
            'Lowercase' => __('Lowercase','sirat'),
    ...
    $wp_customize->add_control( new Sirat_Toggle_Switch_Custom_Control( $wp_customize, 'sirat_related_post',array(
		'label' => esc_html__( 'Show / Hide Related Post','sirat' ),
    ...
    $wp_customize->add_control( new Sirat_Toggle_Switch_Custom_Control( $wp_customize, 'sirat_single_post_breadcrumb',array(
		'label' => esc_html__( 'Show / Hide Breadcrumb','sirat' ),
		'section' => 'sirat_single_blog_settings'
    )));

     // Single Posts Category
  	$wp_customize->add_setting( 'sirat_single_post_category',array(
		'default' => true,
		'transport' => 'refresh',
		'sanitize_callback' => 'sirat_switch_sanitization'
    ) );
  	$wp_customize->add_control( new Sirat_Toggle_Switch_Custom_Control( $wp_customize, 'sirat_single_post_category',array(
		'label' => esc_html__( 'Show / Hide Category','sirat' ),
		'section' => 'sirat_single_blog_settings'
    )));
    ...
    $wp_customize->add_control( new Sirat_Toggle_Switch_Custom_Control( $wp_customize, 'sirat_toggle_tags', array(
		'label' => esc_html__( 'Show / Hide Tags','sirat' ),
		'section' => 'sirat_single_blog_settings'
    )));
    ...
    $wp_customize->add_control( new Sirat_Toggle_Switch_Custom_Control( $wp_customize, 'sirat_single_blog_post_navigation_show_hide', array(
		'label' => esc_html__( 'Show / Hide Post Navigation','sirat' ),
		'section' => 'sirat_single_blog_settings'
    )));
	...
	// Grid layout setting
	$wp_customize->add_section( 'sirat_grid_layout_settings', array(
		'title' => __( 'Grid Layout Settings', 'sirat' ),
		'panel' => 'sirat_blog_post_parent_panel',
	));

  	$wp_customize->add_setting('sirat_grid_postdate_icon',array(
		'default'	=> 'fas fa-calendar-alt',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control(new Sirat_Fontawesome_Icon_Chooser(
        $wp_customize,'sirat_grid_postdate_icon',array(
		'label'	=> __('Add Post Date Icon','sirat'),
		'transport' => 'refresh',
		'section'	=> 'sirat_grid_layout_settings',
		'setting'	=> 'sirat_grid_postdate_icon',
		'type'		=> 'icon'
	)));

	$wp_customize->add_setting( 'sirat_grid_postdate',array(
        'default' => 1,
        'transport' => 'refresh',
        'sanitize_callback' => 'sirat_switch_sanitization'
    ) );
    $wp_customize->add_control( new Sirat_Toggle_Switch_Custom_Control( $wp_customize, 'sirat_grid_postdate',array(
        'label' => esc_html__( 'Show / Hide Post Date','sirat' ),
        'section' => 'sirat_grid_layout_settings'
    )));

	$wp_customize->add_setting('sirat_grid_author_icon',array(
		'default'	=> 'fas fa-user',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control(new Sirat_Fontawesome_Icon_Chooser(
        $wp_customize,'sirat_grid_author_icon',array(
		'label'	=> __('Add Author Icon','sirat'),
		'transport' => 'refresh',
		'section'	=> 'sirat_grid_layout_settings',
		'setting'	=> 'sirat_grid_author_icon',
		'type'		=> 'icon'
	)));

    $wp_customize->add_setting( 'sirat_grid_author',array(
		'default' => 1,
		'transport' => 'refresh',
		'sanitize_callback' => 'sirat_switch_sanitization'
    ) );
    $wp_customize->add_control( new Sirat_Toggle_Switch_Custom_Control( $wp_customize, 'sirat_grid_author',array(
		'label' => esc_html__( 'Show / Hide Author','sirat' ),
		'section' => 'sirat_grid_layout_settings'
    )));

   	$wp_customize->add_setting('sirat_grid_comments_icon',array(
		'default'	=> 'fa fa-comments',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control(new Sirat_Fontawesome_Icon_Chooser(
        $wp_customize,'sirat_grid_comments_icon',array(
		'label'	=> __('Add Comments Icon','sirat'),
		'transport' => 'refresh',
		'section'	=> 'sirat_grid_layout_settings',
		'setting'	=> 'sirat_grid_comments_icon',
		'type'		=> 'icon'
	)));

    $wp_customize->add_setting( 'sirat_grid_comments',array(
		'default' => 1,
		'transport' => 'refresh',
		'sanitize_callback' => 'sirat_switch_sanitization'
    ) );
    $wp_customize->add_control( new Sirat_Toggle_Switch_Custom_Control( $wp_customize, 'sirat_grid_comments',array(
		'label' => esc_html__( 'Show / Hide Comments','sirat' ),
		'section' => 'sirat_grid_layout_settings'
    )));
	...
	$wp_customize->add_control('sirat_grid_post_meta_field_separator',array(
		'label'	=> __('Add Meta Separator','sirat'),
		'description' => __('Add the seperator for meta box. Example: "|", "/", etc.','sirat'),
		'section'=> 'sirat_grid_layout_settings',
		'type'=> 'text'
  	...
  	$wp_customize->add_setting('sirat_display_grid_posts_settings',array(
	    'default' => 'Into Blocks',
	    'transport' => 'refresh',
	    'sanitize_callback' => 'sirat_sanitize_choices'
	));
	$wp_customize->add_control('sirat_display_grid_posts_settings',array(
	    'type' => 'select',
	    'label' => __('Display Grid Posts','sirat'),
	    'section' => 'sirat_grid_layout_settings',
	    'choices' => array(
    		'Into Blocks' => __('Into Blocks','sirat'),
	      	'Without Blocks' => __('Without Blocks','sirat')
	...
	$wp_customize->add_setting('sirat_grid_button_text',array(
		'default'=> esc_html__('Read More','sirat'),
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('sirat_grid_button_text',array(
	...
	$wp_customize->add_setting('sirat_grid_excerpt_suffix',array(
		'default'=> '',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('sirat_grid_excerpt_suffix',array(
		'label'	=> __('Add Excerpt Suffix','sirat'),
		'input_attrs' => array(
            'placeholder' => __( '[...]', 'sirat' ),
        ),
	...
	$wp_customize->add_setting('sirat_grid_excerpt_settings',array(
        'default' => 'Excerpt',
        'transport' => 'refresh',
        'sanitize_callback' => 'sirat_sanitize_choices'
	));
	$wp_customize->add_control('sirat_grid_excerpt_settings',array(
        'type' => 'select',
        'label' => esc_html__('Grid Post Content','sirat'),
        'section' => 'sirat_grid_layout_settings',
        'choices' => array(
        	'Content' => esc_html__('Content','sirat'),
    ...
    $wp_customize->add_control( new Sirat_Toggle_Switch_Custom_Control( $wp_customize, 'sirat_single_page_breadcrumb',array(
		'label' => esc_html__( 'Show / Hide Page Breadcrumb','sirat' ),
		'section' => 'sirat_left_right'
    )));
    ...
    $wp_customize->add_control( new Sirat_Toggle_Switch_Custom_Control( $wp_customize, 'sirat_animation',array(
        'label' => esc_html__( 'Show / Hide Animations','sirat' ),
    ...
    $wp_customize->add_control( new Sirat_Toggle_Switch_Custom_Control( $wp_customize, 'sirat_loader_enable',array(
        'label' => esc_html__( 'Show / Hide Pre-Loader','sirat' ),
        'section' => 'sirat_left_right'
    )));
	...
	$wp_customize->add_setting('sirat_preloader_bg_img',array(
		'default'	=> '',
		'sanitize_callback'	=> 'esc_url_raw',
	));
	$wp_customize->add_control( new WP_Customize_Image_Control($wp_customize,'sirat_preloader_bg_img',array(
    ...
    $wp_customize->add_setting( 'sirat_responsive_preloader_hide',array(
        'default' => false,
        'transport' => 'refresh',
        'sanitize_callback' => 'sirat_switch_sanitization'
    ) );
    $wp_customize->add_control( new Sirat_Toggle_Switch_Custom_Control( $wp_customize, 'sirat_responsive_preloader_hide',array(
        'label' => esc_html__( 'Show / Hide Preloader','sirat' ),
        'section' => 'sirat_responsive_media'
    )));
    ...
    $wp_customize->add_control( new Sirat_Toggle_Switch_Custom_Control( $wp_customize, 'sirat_woocommerce_shop_page_sidebar',array(
		'label' => esc_html__( 'Show / Hide Shop Page Sidebar','sirat' ),
		'section' => 'sirat_wocommerce_section'
    )));

    $wp_customize->add_setting('sirat_shop_page_layout',array(
        'default' => 'Right Sidebar',
        'sanitize_callback' => 'sirat_sanitize_choices'
	));
	$wp_customize->add_control('sirat_shop_page_layout',array(
        'type' => 'select',
        'label' => __('Shop Page Sidebar Layout','sirat'),
        'section' => 'sirat_wocommerce_section',
        'choices' => array(
            'Left Sidebar' => __('Left Sidebar','sirat'),
            'Right Sidebar' => __('Right Sidebar','sirat'),
    ...
    $wp_customize->add_control( new Sirat_Toggle_Switch_Custom_Control( $wp_customize, 'sirat_woocommerce_single_product_page_sidebar',array(
		'label' => esc_html__( 'Show / Hide Single Product Sidebar','sirat' ),
		'section' => 'sirat_wocommerce_section'
    )));

	$wp_customize->add_setting('sirat_single_product_layout',array(
        'default' => 'Right Sidebar',
        'sanitize_callback' => 'sirat_sanitize_choices'
	));
	$wp_customize->add_control('sirat_single_product_layout',array(
        'type' => 'select',
        'label' => __('Single Product Sidebar Layout','sirat'),
        'section' => 'sirat_wocommerce_section',
        'choices' => array(
            'Left Sidebar' => __('Left Sidebar','sirat'),
            'Right Sidebar' => __('Right Sidebar','sirat'),
    ...
    $wp_customize->add_control( new Sirat_Toggle_Switch_Custom_Control( $wp_customize, 'sirat_related_product_show_hide',array(
        'label' => esc_html__( 'Show / Hide Related product','sirat' ),
        'section' => 'sirat_wocommerce_section'
    )));
	...
	*/
	public function sections( $manager ) {
		...
		$manager->add_section( new Sirat_Customize_Section_Pro( $manager,'sirat_upgrade_pro_link', array(
			...
			'pro_url'  => esc_url('https://www.vwthemes.com/products/multipurpose-wordpress-theme'),
		) )	);
		...
		$manager->add_section(new Sirat_Customize_Section_Pro($manager,'sirat_get_started_link',array(
			...
			'pro_url'  => esc_url('https://preview.vwthemesdemo.com/docs/free-sirat/'),
		)));
	}
