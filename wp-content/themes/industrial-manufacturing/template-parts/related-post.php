				...
				<div class="col-lg-4 col-md-4">
				    <article class="blog-sec text-start p-2 mb-4">
			            ...
			            <?php if(get_the_excerpt()) { ?>
			                <div class="entry-content"><p><?php $industrial_manufacturing_excerpt = get_the_excerpt(); echo esc_html( industrial_manufacturing_string_limit_words( $industrial_manufacturing_excerpt, esc_attr(get_theme_mod('industrial_manufacturing_related_post_excerpt_number','20')))); ?> <?php echo esc_html( get_theme_mod('industrial_manufacturing_button_excerpt_suffix','...') ); ?></p></div>
				        <?php }?>
