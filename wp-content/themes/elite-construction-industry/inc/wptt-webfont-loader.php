...
if ( ! class_exists( 'Elite_Construction_Industry_WPTT_WebFont_Loader' ) ) {
	/**
	 * Download webfonts locally.
	 */
	class Elite_Construction_Industry_WPTT_WebFont_Loader {
...
if ( ! function_exists( 'wptt_get_webfont_styles' ) ) {
	...
	function wptt_get_webfont_styles( $url, $format = 'woff2' ) {
		$font = new Elite_Construction_Industry_WPTT_WebFont_Loader( $url );
