...
<div id="sidebar">    
    <?php if ( ! dynamic_sidebar( 'sidebar-primary' ) ) : ?>
		...
		<aside id="search" class="widget widget_search" role="complementary" aria-label="firstsidebar">
		    <h5 class="widget-title"><?php esc_html_e('Search', 'elite-construction-industry'); ?></h5>
		...
		<aside id="meta" class="widget widget_meta" role="complementary" aria-label="firstsidebar">
		    <h5 class="widget-title"><?php esc_html_e('Meta', 'elite-construction-industry'); ?></h5>
		    <span class="animate-border border-black"></span>
		    <ul>
		        <?php wp_register(); ?>
		...
		<aside id="categories" class="widget widget_categories" role="complementary" aria-label="firstsidebar">
		    <h5 class="widget-title"><?php esc_html_e('Categories', 'elite-construction-industry'); ?></h5>
		    <span class="animate-border border-black"></span>
		    <ul>
		        <?php
